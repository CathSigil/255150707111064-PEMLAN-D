...
public class NilaiGUI extends Frame implements ActionListener {
    ...
    public NilaiGUI() {
        setLayout(null);
        Label lbJudul = new Label("Hitung Nilai Akhir");
...
lbHasil.setBounds(90, 210, 50, 20);
        ...
        cbASD.setBounds(50,70,70,20);
        cbPemlan.setBounds(120,70,80,20);
        cbMatkomlan.setBounds(200,70,100,20);
        cbProbstat.setBounds(310,70,100,20);
